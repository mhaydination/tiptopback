...
exports.modifyUser = async (req, res) => {
  try {
    ...
    const { email, oldPassword, newPassword, newPasswordConfirm, newEmail, username } = req.body;
    console.log("🚀 ~ exports.modifyUser= ~  req.body:", req.body);
    ...
    // Update the password if newPassword and newPasswordConfirm are provided
    ...
    if (newEmail && newEmail !== user.email) {
      // Ensure newEmail is not already taken
    ...
    console.log("🚀 ~ exports.modifyUser= ~ updatedUser:", updatedUser);
